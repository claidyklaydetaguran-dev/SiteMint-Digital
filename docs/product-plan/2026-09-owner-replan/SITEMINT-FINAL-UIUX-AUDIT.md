...
|---|---|---|---|---|
| Home hero | Flagship brand statement + film | 4:1 strip felt detached; film generic | Integrated stage: film 55–60% of usable hero, particles 40–45%, signal seam, pause control; flagship 6-beat film generated from verified text-free keyframes; labels page-rendered | `pages/HomeV4.tsx`, `styles/v5-home.css` |
