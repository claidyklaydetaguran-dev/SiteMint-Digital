...
| Live performance (3-run throttled-mobile medians on `https://sitemintdigital.com`) | Home LCP 2.91s · CLS 0.000 · TBT 155ms · score 90 — Receptionist LCP 2.55s · CLS 0.000 · TBT 19ms · score 94 (the local-preview 4.03s figure was the uncompressed-static-server number; the production edge serves gzip over HTTP/3). Stuck-reveal scan on 12 live routes: 0 stuck. |
