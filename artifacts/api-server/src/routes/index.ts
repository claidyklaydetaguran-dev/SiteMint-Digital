...
import crmCompaniesRouter from "./crmCompanies";
...
import receptionistVoiceOptionsRouter from "./receptionistVoiceOptions";
...
import receptionistReadinessRouter from "./receptionistReadiness";
import receptionistDashboardRouter from "./receptionistDashboard";
...
// Before crmRouter for the same reason: /crm/companies and
// /crm/companies/suggestions are literal paths and must reach their own
// handlers rather than a parameterised /crm/:something.
router.use(crmCompaniesRouter);
...
router.use(receptionistVoiceOptionsRouter);
...
router.use(receptionistReadinessRouter);
router.use(receptionistDashboardRouter);
