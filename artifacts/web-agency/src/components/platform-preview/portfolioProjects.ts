...
export const portfolioProjects: PortfolioProject[] = [
  ...
  {
    id: "simply-save-solar",
    projectName: "Simply Save Solar",
    category: "Solar Education & Estimates",
    industry: "Solar education and estimate platform",
    summary:
      "A responsive solar platform that helps homeowners understand solar, battery storage, roofing, and financing options—and move confidently toward a personalized estimate.",
    contribution: [
      "Website strategy",
      "Responsive design",
    ...
    publicUrl: "https://simplysavesolar.com/",
    ctaLabel: "Visit Simply Save Solar",
    desktopAsset: {
      src: "/portfolio/current/simply-save-solar-desktop.webp",
      width: 1221,
      height: 850,
      alt: "Simply Save Solar website homepage on desktop, showing the solar hero and the no-obligation estimate pathway",
    },
    mobileAsset: {
      src: "/portfolio/current/simply-save-solar-mobile.webp",
      width: 388,
      height: 838,
