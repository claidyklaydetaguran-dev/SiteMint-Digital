...
import receptionist from "@/assets/mint/receptionist-scene.webp";
...
export function MintPageStory({ kind }: { kind: keyof typeof stories }) {
  ...
  return <section className="section wrap story-chapter mint-page-story">
    <figure className="story-image"><img src={story.image} alt={story.alt} width="1536" height="1024" loading="lazy" decoding="async" /><figcaption>{kind === "work" ? "Illustrative website concept" : "Illustrative business scene"}</figcaption></figure>
...
const needs = [
  ...
  { label: "Help with incoming calls", title: "Turn a ringing phone into a useful conversation.", copy: "An assisted receptionist pilot starts with your real services and rules. We configure the assistant with you and test the booking, message and transfer paths before relying on it.", image: receptionist, alt: "Illustrative technician focused on a customer job", href: "/ai-receptionist", link: "Meet the AI receptionist", steps: ["Understand the caller", "Follow your business rules", "Record the next step"] },
