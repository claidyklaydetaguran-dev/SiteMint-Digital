      ...
      <section style={{ background: "#051824", padding: "48px 24px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 32 }}>
          {[
            ...
            <motion.div key={label} initial="hidden" animate="show" variants={fadeUp}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <div style={{
                ...
                {[
                  ...
                  <motion.div key={i} initial={{ opacity: 0, x: msg.from === "visitor" ? 12 : -12 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.08 }}
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
            {[
              ...
              <motion.div key={i} initial="hidden" animate="show" variants={fadeUp}
                style={{
                  background: "linear-gradient(135deg, #051824 0%, #162936 100%)",
