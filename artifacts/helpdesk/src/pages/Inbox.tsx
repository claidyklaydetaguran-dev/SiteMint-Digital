...
export default function Inbox() {
  ...
  return (
    <>
      ...
      <div className="flex md:hidden h-full w-full flex-col overflow-hidden bg-slate-50 font-sans text-slate-900">
        {mobileView === "list" ? (
          <>
            <MobileFilterBar
              ...
              <>
                <div className="flex items-center gap-3 px-4 py-3 border-b border-slate-200 bg-white flex-shrink-0">
                  <button
                    ...
                    className="flex items-center gap-1.5 text-xs font-medium text-indigo-600 hover:text-indigo-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded"
      ...
      <div className="hidden md:flex h-full w-full overflow-hidden bg-slate-50 font-sans text-slate-900">
        <CategoryRail
...
function MobileFilterBar({
  ...
  return (
    <div className="flex-shrink-0 bg-white border-b border-slate-200 px-3 pt-2 pb-2 space-y-2">
      {/* Search */}
        ...
        {MOBILE_CATS.map((cat) => {
          ...
          return (
            <button
              ...
              className={`flex-shrink-0 px-3 py-1 rounded-full text-xs font-medium transition-colors border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 ${
                isActive
        ...
        <div className="flex gap-1.5 overflow-x-auto no-scrollbar pb-0.5" role="group" aria-label="Filter by tier">
          {tierFilter !== null && (
            <button
              ...
              className="flex-shrink-0 text-[10px] font-medium px-2 py-0.5 rounded-full border bg-white text-slate-500 border-slate-200 hover:border-slate-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
          ...
          {availableTiers.map((tier) => {
            ...
            return (
              <button
                ...
                aria-pressed={isActive}
                className={`flex-shrink-0 text-[10px] font-semibold px-2 py-0.5 rounded-full border transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 ${
...
function NavItem({
  ...
  return (
    <div
      ...
      aria-pressed={active}
      className={`flex items-center justify-between px-2 py-1.5 rounded-md text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 ${
        disabled
        ...
        {!hideTierChips && availableTiers.length > 0 && (
          <div className="flex flex-wrap gap-1.5 mt-2.5" role="group" aria-label="Filter by tier">
            {tierFilter !== null && (
              <button
                onClick={() => onTierFilter(null)}
                className="text-[10px] font-medium px-2 py-0.5 rounded-full border bg-white text-slate-500 border-slate-200 hover:border-slate-300 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
                aria-label="Clear tier filter"
              >
                All ×
              </button>
            ...
            {availableTiers.map((tier) => {
              ...
              return (
                <button
                  key={tier}
                  onClick={() => onTierFilter(isActive ? null : tier)}
                  className={`text-[10px] font-semibold px-2 py-0.5 rounded-full border transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 ${
                    isActive ? TIER_CHIP_ACTIVE[tier] : TIER_CHIP_INACTIVE
                  }`}
                  aria-pressed={isActive}
                >
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        {isLoading ? (
          ...
          <div className="text-center py-12 px-4">
            ...
            <p className="text-xs text-slate-500 mt-1">{emptyHelper}</p>
          </div>
        ) : (
          conversations.map((c) => (
            <ConversationCard
...
function ConversationCard({
  ...
  return (
    <div
      ...
      className={`p-3 rounded-lg border cursor-pointer transition-all relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 ${
        selected
      ...
      <div className="flex items-center justify-between mb-1.5">
        ...
        <span
          className={`text-xs flex-shrink-0 ml-2 tabular-nums ${
            selected ? "text-indigo-600 font-medium" : "text-slate-500"
          }`}
        >
...
function ThreadPanel({
  ...
  return (
    <div className="flex-1 min-w-0 flex flex-col bg-white">
      {/* Thread header */}
      <div className="border-b border-slate-200 px-4 md:px-5 py-3 md:py-4 flex-shrink-0">
        {/* Back button (mobile only) */}
        {onBack && (
          <button
            onClick={onBack}
            className="flex items-center gap-1.5 text-xs font-medium text-indigo-600 hover:text-indigo-700 mb-2.5 -ml-0.5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded"
            aria-label="Back to conversations list"
          >
        ...
        <div className="flex items-start justify-between gap-2">
          ...
          {onToggleDetails && (
            <button
              ...
              className="flex items-center gap-1 text-xs text-slate-500 hover:text-slate-700 flex-shrink-0 mt-0.5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded px-1"
            >
              Details
              <ChevronDown
      ...
      {/* Message thread */}
      <div ref={threadRef} className="flex-1 overflow-y-auto px-4 md:px-5 py-4 space-y-1 bg-slate-50/40">
        {messages.length === 0 ? (
      ...
      <div className="border-t border-slate-200 bg-white flex-shrink-0 px-4 md:px-5 py-3.5">
      ...
      {showDetails && onToggleDetails && (
        <div className="border-t border-slate-200 overflow-y-auto max-h-[45vh] flex-shrink-0 md:hidden">
      ...
      >
        ...
        <p
          className={`text-[10px] mt-1.5 ${
            isOutbound ? "text-indigo-200" : "text-slate-500"
          }`}
        >
    ...
    <div
      className={
        embedded
          ...
          : "w-[260px] flex-shrink-0 border-l border-slate-200 bg-white flex flex-col overflow-y-auto"
      }
    >
      ...
      <div className="p-4 space-y-5">
        ...
        <section aria-label="Caller info">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="text-xs text-slate-500">Via SMS</div>
            </div>
          </div>
        </section>
        ...
        <section aria-label="Timeline">
          ...
          <div className="space-y-2 text-xs text-slate-600">
            <div className="flex items-start justify-between gap-2">
              <span className="text-slate-500 flex-shrink-0">Started</span>
              <span className="text-right">{formatDateTime(c.createdAt)}</span>
            </div>
            <div className="flex items-start justify-between gap-2">
              <span className="text-slate-500 flex-shrink-0">Last msg</span>
